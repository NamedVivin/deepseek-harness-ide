...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/connection-desktop': { kind: 'none', reason: 'Desktop IPC carrier; transports already-composed protocol messages without adding model input.' },
  'packages/client/connection-web': { kind: 'none', reason: 'Web carrier; transports already-composed protocol messages without adding model input.' },
  'packages/client/modules-desktop': { kind: 'none', reason: 'Desktop Client bundle delivery registers no model-facing content.' },
  'packages/client/modules-web': { kind: 'none', reason: 'Web Client bundle delivery registers no model-facing content.' },
  ...
  'packages/client/ui-directory-picker-desktop': { kind: 'none', reason: 'Desktop workspace-registration UI flow; registers nothing model-facing.' },
  'packages/client/ui-ide': { kind: 'none', reason: 'Browser-side editor surface; registers nothing model-facing.' },
  ...
  'packages/host/directory-picker-electron': { kind: 'none', reason: 'The Electron directory-picker backend registers nothing model-facing.' },
  'packages/host/workspace-files': { kind: 'none', reason: 'The IDE file BFF registers no prompt, tool, message, or provider request.' },
  'packages/host/workspace-registration': { kind: 'none', reason: 'The native workspace-registration BFF registers nothing model-facing.' },
  ...
  'packages/bundle/desktop-app': { kind: 'indirect', reason: 'The bundle mounts a fixed preset whose consumer packages own all model-facing registrations.' },
  'packages/bundle/ide-app': { kind: 'none', reason: 'The IDE capability bundle registers Host and Client surfaces but no model-facing content.' },
  ...
  'packages/subprocess/subprocess-collector': { kind: 'indirect', reason: 'The collection library delegates rendering of tails and spill recovery to subprocess consumers.' },
  ...
  'packages/e2b/subprocess-pty-e2b': { kind: 'indirect', reason: 'The remote PTY backend delegates model rendering to terminal consumers.' },
  ...
  'packages/subprocess/subprocess-pty': { kind: 'indirect', reason: 'The PTY seam delegates all model rendering to terminal consumers.' },
  'packages/subprocess/subprocess-pty-local': { kind: 'indirect', reason: 'The local PTY backend delegates model rendering to terminal consumers.' },
  'packages/subprocess/subprocess-guardian': { kind: 'indirect', reason: 'The guardian provider delegates model rendering to subprocess and shell consumers.' },
