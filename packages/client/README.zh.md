...
| [`modules/`](modules/README.zh.md) | 发现并加载载体中立的 renderer 模块。 |
| [`modules-web/`](modules-web/README.zh.md) | 通过 Web 路由与 index 注入交付 Client bundle。 |
| [`modules-desktop/`](modules-desktop/README.zh.md) | 把已签名 Client bundle 映射到不可变 `dsh-app://` URL。 |
| [`ui-renderer/`](ui-renderer/README.zh.md) | 将 slot 数据绑定到 React，并在客户端启动稳定后挂载组装完成的应用。 |
| [`connection/`](connection/README.zh.md) | 持有载体中立的 RPC registry、Client handle 与事件循环 consumer。 |
| [`connection-web/`](connection-web/README.zh.md) | 通过受信任的 HTTP route 与 WebSocket 下行流承载 Connection。 |
| [`connection-desktop/`](connection-desktop/README.zh.md) | 通过类型化且有界的桌面 child IPC 承载 Connection。 |
...
| [`ui-directory-picker-desktop/`](ui-directory-picker-desktop/README.zh.md) | 在 Host 内部注册原生桌面选择结果。 |
| [`ui-ide/`](ui-ide/README.zh.md) | 提供工作区文件浏览、编辑、Markdown 预览与 CAS 恢复。 |
