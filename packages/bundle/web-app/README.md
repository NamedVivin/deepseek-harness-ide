...
The manifest anchors both the worker-thread code-runtime provider and its Service Definition so production deploys do not depend on workspace peer hoisting.
