...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('desktop-preset-unsupported'), message: z.string(), details: z.object({ agentPreset: z.string(), operation: z.string(), reason: z.string(), supportedPreset: z.string().optional() }) }),
