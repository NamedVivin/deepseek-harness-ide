...
import type { ProcessInspectorInternals } from '@deepseek-ai/dsh-subprocess-pty-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@deepseek-ai/dsh-subprocess-pty-local/src/windows-inspector.ts'
