...
| [`subprocess-e2b`](subprocess-e2b/README.md) (`@deepseek-ai/dsh-subprocess-e2b`) | `ctx.subprocess` | Implement executable lookup, managed process groups, stdio, and remote spill files over E2B Commands |
| [`subprocess-pty-e2b`](subprocess-pty-e2b/README.md) (`@deepseek-ai/dsh-subprocess-pty-e2b`) | `ctx.subprocessPty` | Optionally implement terminal sessions and foreground operations over E2B PTY APIs |

The existing [`dsh-bash-local`](../shell/bash-local/README.md), [`dsh-terminal-bash`](../terminal/terminal-bash/README.md), and [`dsh-lsp-stdio`](../lsp/lsp-stdio/README.md) need no E2B-specific forks. They delegate execution-world operations to `ctx.fs`, `ctx.subprocess`, and optionally `ctx.subprocessPty`, so mounting the corresponding E2B adapters places their mutable work in the same sandbox.
